<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\wamp\www\tp5\public/../application/index\view\index\index.html";i:1525447763;s:39:"../application/index/common/header.html";i:1523430779;s:38:"../application/index/common/right.html";i:1525446086;s:37:"../application/index/common/foot.html";i:1521521025;}*/ ?>
...
<script type='text/javascript' src='http://127.0.0.1/tp5/public/static/index/images/js/ismobile.js'></script>
</head>
...
<div class="overall">
    ...
    <div class="left">
        <?php if(is_array($articleres) || $articleres instanceof \think\Collection || $articleres instanceof \think\Paginator): $i = 0; $__LIST__ = $articleres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <div class="xnews2">
                <div class="pic"><a target="_blank" ><img src="<?php if($vo['pic'] != ''): ?>http://127.0.0.1/tp5/public/<?php echo $vo['pic']; else: ?>http://127.0.0.1/tp5/public/static/index/images/error.png<?php endif; ?>" alt=""/></a></div>
                <div class="dec">

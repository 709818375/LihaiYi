<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\wamp\www\tp5\public/../application/admin\view\article\lst.html";i:1521794431;s:36:"../application/admin/common/top.html";i:1523431717;s:37:"../application/admin/common/left.html";i:1521689969;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>后台管理</title>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                                ...
                                <td align="center">
                                   <?php if($vo['pic'] != ''): ?>
                            <img src="http://127.0.0.1/tp5/public/<?php echo $vo['pic']; ?>" height="50">
                                <?php else: ?>
                               暂无图片
                                <?php endif; ?></td>
                                ...
                                <td align="center">
                                    ...
                                    <a href="<?php echo url('Article/del',array('id'=>$vo['id'])); ?>"
